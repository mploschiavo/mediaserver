...
from media_stack.cli.workflows.controller_script_runner_service import (  # noqa: E402
...
class ControllerScriptRunnerServiceTests(unittest.TestCase):
    def test_run_script_executes_shell_script(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            svc = ControllerScriptRunnerService(cfg=ControllerScriptRunnerConfig(root_dir=root))
