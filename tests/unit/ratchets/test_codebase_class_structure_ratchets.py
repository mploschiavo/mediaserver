...
PRINT_STATEMENTS_RATCHET = 261      # should use logging/runtime_platform.log
...
FILES_OVER_400_LINES_RATCHET = 97  # 92 → 91 — ADR-0010 Phase 7 cleanup: deleting ``api/services/lifecycle_ensurer_invoker.py`` (402 LoC, retired with the lifecycle-dispatch indirection) drops the over-400 file count by 1. Tightened to the new floor; "tighten on improvements" rule.
