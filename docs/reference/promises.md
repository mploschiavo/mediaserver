...
<!-- Source: contracts/promises/promises.yaml. Edit the YAML, then re-run the script. -->
...
3. Add an entry to [`contracts/promises/promises.yaml`](../../contracts/promises/promises.yaml) with a probe that proves it works, and a `platforms:` tag.
