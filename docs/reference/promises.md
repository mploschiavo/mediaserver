<!-- AUTO-GENERATED by media-stack-render-promises -->
<!-- Source: contracts/promises/cross_cutting.yaml. Edit the YAML, then re-run the script. -->

# Promises Reference

Every claim like "after a fresh install, Bazarr has English subtitles enabled" lives in [`contracts/promises/cross_cutting.yaml`](../../contracts/promises/cross_cutting.yaml) as a single declarative entry. Three things consume that file:
...
3. Add an entry to [`contracts/promises/cross_cutting.yaml`](../../contracts/promises/cross_cutting.yaml) with a probe that proves it works, and a `platforms:` tag.
4. Re-run this script: `media-stack-render-promises`.
