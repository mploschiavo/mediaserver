...
<!-- Source: .ratchets/promises/promises.yaml. Edit the YAML, then re-run the script. -->

# Promises Reference

Every claim like "after a fresh install, Bazarr has English subtitles enabled" lives in [`.ratchets/promises/promises.yaml`](../../.ratchets/promises/promises.yaml) as a single declarative entry. Three things consume that file:
...
3. Add an entry to [`.ratchets/promises/promises.yaml`](../../.ratchets/promises/promises.yaml) with a probe that proves it works, and a `platforms:` tag.
