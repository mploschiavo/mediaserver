...
>(({ className, sideOffset = 6, children, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "z-50 overflow-hidden rounded-md border border-border bg-bg-3 px-2 py-1 text-xs font-medium text-fg shadow-md",
    ...
    >
      {children}
      <TooltipPrimitive.Arrow className="fill-bg-3" width={10} height={5} />
    </TooltipPrimitive.Content>
  </TooltipPrimitive.Portal>
));
