...
def main(argv=None):
    ...
    with PortForward(pf_cmd) as pf:
        ...
        if existing_api_key and validate_api_key(base_url, existing_api_key, http_request=http_request):
        ...
        if auth_result is None:
            ...
            if discovered_key and validate_api_key(base_url, discovered_key, http_request=http_request):
