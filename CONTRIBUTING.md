...
4. If your PR changes a behavior covered by [`.ratchets/promises/promises.yaml`](.ratchets/promises/promises.yaml), update the promise. If you add a new OTB guarantee, add a new promise and re-run `media-stack-render-promises`.
