...
class DiskService:
    """Disk usage monitoring, guardrail configuration, and cleanup preview."""
    ...
    def get_disk(self) -> dict[str, Any]:
        ...
        guardrails = self._load_guardrail_config()
    ...
    def validate_migration_target(self, target_path: str) -> dict[str, Any]:
        ...
        source = self.get_storage_breakdown()
    ...
    def preview_cleanup(self) -> dict[str, Any]:
        ...
        gc = self._load_guardrail_config()
...
_instance = DiskService()

# Backward compat — callers use module-level functions
get_disk = _instance.get_disk
get_storage_breakdown = _instance.get_storage_breakdown
validate_migration_target = _instance.validate_migration_target
_load_guardrail_config = _instance._load_guardrail_config
update_guardrails = _instance.update_guardrails
preview_cleanup = _instance.preview_cleanup
