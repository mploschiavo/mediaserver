...
import yaml
from media_stack.core.bootstrap_profile import BootstrapProfileConfig
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        default="contracts/media-stack.profile.yaml",
        help="Path to bootstrap profile YAML",
    )
    parser.add_argument(
        "--schema",
        default="contracts/media-stack.profile.schema.json",
