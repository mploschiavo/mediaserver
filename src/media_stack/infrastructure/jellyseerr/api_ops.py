"""Migration shim — see ``media_stack.services.apps.jellyseerr.api_ops``.
...
from ``media_stack.infrastructure.jellyseerr.api_ops`` directly.
"""

from media_stack.services.apps.jellyseerr.api_ops import *  # noqa: F401, F403
