"""Migration shim — see ``media_stack.services.apps.jellyseerr.file_ops``.
...
from ``media_stack.infrastructure.jellyseerr.file_ops`` directly.
"""

from media_stack.services.apps.jellyseerr.file_ops import *  # noqa: F401, F403
