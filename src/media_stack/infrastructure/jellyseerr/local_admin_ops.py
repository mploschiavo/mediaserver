"""Migration shim — see ``media_stack.services.apps.jellyseerr.local_admin_ops``.
...
from ``media_stack.infrastructure.jellyseerr.local_admin_ops`` directly.
"""

from media_stack.services.apps.jellyseerr.local_admin_ops import *  # noqa: F401, F403
