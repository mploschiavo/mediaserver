"""Migration shim — see ``media_stack.services.apps.prowlarr.reputation_ops``.
...
from ``media_stack.infrastructure.prowlarr.reputation_ops`` directly.
"""

from media_stack.services.apps.prowlarr.reputation_ops import *  # noqa: F401, F403
