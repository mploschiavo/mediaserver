"""Migration shim — see ``media_stack.services.apps.prowlarr.application_ops``.
...
from ``media_stack.infrastructure.prowlarr.application_ops`` directly.
"""

from media_stack.services.apps.prowlarr.application_ops import *  # noqa: F401, F403
