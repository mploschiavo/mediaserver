"""Migration shim — see ``media_stack.services.apps.prowlarr.proxy_ops``.
...
from ``media_stack.infrastructure.prowlarr.proxy_ops`` directly.
"""

from media_stack.services.apps.prowlarr.proxy_ops import *  # noqa: F401, F403
