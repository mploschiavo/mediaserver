"""Migration shim — see ``media_stack.services.apps.prowlarr.indexer_ops``.
...
from ``media_stack.infrastructure.prowlarr.indexer_ops`` directly.
"""

from media_stack.services.apps.prowlarr.indexer_ops import *  # noqa: F401, F403
