"""Migration shim — see ``media_stack.services.apps.prowlarr.flaresolverr_service``.
...
from ``media_stack.infrastructure.prowlarr.flaresolverr_service`` directly.
"""

from media_stack.services.apps.prowlarr.flaresolverr_service import *  # noqa: F401, F403
