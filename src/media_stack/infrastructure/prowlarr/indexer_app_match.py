"""Migration shim — see ``media_stack.services.apps.prowlarr.indexer_app_match``.
...
from ``media_stack.infrastructure.prowlarr.indexer_app_match`` directly.
"""

from media_stack.services.apps.prowlarr.indexer_app_match import *  # noqa: F401, F403
