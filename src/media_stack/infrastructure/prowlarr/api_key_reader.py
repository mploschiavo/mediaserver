"""Migration shim — see ``media_stack.services.apps.prowlarr.api_key_reader``.
...
from ``media_stack.infrastructure.prowlarr.api_key_reader`` directly.
"""

from media_stack.services.apps.prowlarr.api_key_reader import *  # noqa: F401, F403
