...
class JellyfinComposePreflight:
    ...
    def ensure_compose_jellyfin_bootstrap_access(self, 
        *,
        compose_env: dict[str, str],
        namespace: str,
        docker: Any,
...
_instance = JellyfinComposePreflight()
ensure_compose_jellyfin_bootstrap_access = _instance.ensure_compose_jellyfin_bootstrap_access
