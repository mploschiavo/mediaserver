...
from .controller_config_service import parse_jellyfin_bootstrap_config
from .controller_db_discovery_service import (
    discover_api_key_from_jellyfin_db,
)
from .controller_kube_service import (
    PortForward,
    choose_kubectl,
    get_secret,
    patch_secret,
...
class EnsureJellyfinControllerMain:
    ...
    def http_request(self, base_url, path, method="GET", payload=None, headers=None, timeout=20):
        ...
        with PortForward(pf_cmd) as pf:
            ...
            if auth_result is None:
                ...
                fail(
                    ...
                    "using bin/set-jellyfin-api-key.sh, then rerun bootstrap."
                )
