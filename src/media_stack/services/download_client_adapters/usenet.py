"""Migration shim — see ``media_stack.adapters.download_client_adapters.usenet``.
...
``src/`` or ``tests/`` imports from ``media_stack.services.download_client_adapters.usenet`` directly.
"""

from media_stack.adapters.download_client_adapters.usenet import *  # noqa: F401, F403
