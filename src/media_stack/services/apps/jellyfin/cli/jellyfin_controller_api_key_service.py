...
class JellyfinControllerApiKeyService:
...
_instance = JellyfinControllerApiKeyService()
ensure_api_key = _instance.ensure_api_key
validate_api_key = _instance.validate_api_key
lookup_user_id_with_api_key = _instance.lookup_user_id_with_api_key
