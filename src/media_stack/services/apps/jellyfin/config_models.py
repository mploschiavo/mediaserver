"""Shim — moved to ``media_stack.domain.jellyfin.config_models`` in
ADR-0002 Phase 16-D batch 1. Phase 16-F removes this shim.
"""

from media_stack.domain.jellyfin.config_models import *  # noqa: F401,F403
from media_stack.domain.jellyfin.config_models import (  # noqa: F401
