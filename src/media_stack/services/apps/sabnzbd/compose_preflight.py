"""Shim — moved to
``media_stack.infrastructure.sabnzbd.compose_preflight`` in ADR-0002
Phase 16-D batch 3. Phase 16-F removes this shim.
...
from media_stack.infrastructure.sabnzbd import compose_preflight as _impl
