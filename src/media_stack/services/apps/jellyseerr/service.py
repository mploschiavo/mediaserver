"""Migration shim — see ``media_stack.application.jellyseerr.service``.
...
from ``media_stack.services.apps.jellyseerr.service`` directly.
"""

from media_stack.application.jellyseerr.service import *  # noqa: F401, F403
