...
class JellyseerrRuntimeOps:

    def read_jellyseerr_api_key(self, config_root, timeout_seconds=120):
...
_instance = JellyseerrRuntimeOps()
...
_jellyseerr_service = _instance._jellyseerr_service
