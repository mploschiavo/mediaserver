"""Migration shim — see ``media_stack.application.prowlarr.service``.
...
from ``media_stack.services.apps.prowlarr.service`` directly.
"""

from media_stack.application.prowlarr.service import *  # noqa: F401, F403
