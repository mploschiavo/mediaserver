"""Migration shim — see ``media_stack.application.prowlarr.precheck_service``.
...
from ``media_stack.services.apps.prowlarr.precheck_service`` directly.
"""

from media_stack.application.prowlarr.precheck_service import *  # noqa: F401, F403
