...
class ServarrQbitOps:
    ...
    def qbit_login(self, base_url, username, password):
        return _torrent_client_service(_cfg_with_url_hint({}, base_url)).login(
            base_url, username, password
        )

    def torrent_client_login(self, base_url, username, password):
        return qbit_login(base_url, username, password)

    def qbit_create_category(self, opener, base_url, category, save_path):
    ...
    def qbit_set_preferences(self, opener, base_url, preferences):
    ...
    def qbit_list_torrents(self, opener, base_url, filter_value="all"):
    ...
    def qbit_list_completed_torrents(self, opener, base_url):
        return _torrent_client_service(_cfg_with_url_hint({}, base_url)).list_completed_torrents(
            opener, base_url
        )

    def qbit_delete_torrents(self, opener, base_url, hashes, delete_files=True):
    ...
    def setup_qbit_storage_defaults(self, opener, qbit_url, qbit_cfg):
    ...
    def setup_torrent_storage_defaults(self, opener, torrent_client_url, torrent_client_cfg):
        return setup_qbit_storage_defaults(opener, torrent_client_url, torrent_client_cfg)

    def setup_qbit_categories(self, arr_apps, qbit_cfg, qb_username, qb_password):
        qbit_url = ""
    ...
    def setup_torrent_categories(self, 
        arr_apps,
        torrent_client_cfg,
...
_instance = ServarrQbitOps()
qbit_login = _instance.qbit_login
torrent_client_login = _instance.torrent_client_login
qbit_create_category = _instance.qbit_create_category
qbit_set_preferences = _instance.qbit_set_preferences
qbit_list_torrents = _instance.qbit_list_torrents
qbit_list_completed_torrents = _instance.qbit_list_completed_torrents
qbit_delete_torrents = _instance.qbit_delete_torrents
setup_qbit_storage_defaults = _instance.setup_qbit_storage_defaults
