"""Shim — moved to ``media_stack.application.servarr.configure_arr_clients_job`` in
...
from media_stack.application.servarr import configure_arr_clients_job as _impl
