"""Migration shim — see ``media_stack.application.maintainerr.rule_sync_service``.
...
from ``media_stack.services.apps.maintainerr.rule_sync_service`` directly.
"""

from media_stack.application.maintainerr.rule_sync_service import *  # noqa: F401, F403
