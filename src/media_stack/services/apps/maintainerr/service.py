"""Migration shim — see ``media_stack.application.maintainerr.service``.
...
from ``media_stack.services.apps.maintainerr.service`` directly.
"""

from media_stack.application.maintainerr.service import *  # noqa: F401, F403
