...
class LiveTvConfigEnrichmentService:
    """Enriches raw Live TV profile entries with resolved URLs and defaults."""
    ...
    def enrich_livetv_entries(self, cfg: dict[str, Any], profile: dict[str, Any]) -> None:
        ...
        for guide in raw_guides:
            ...
            code = self.extract_country_code(guide_name, path)
        ...
        for tuner in raw_tuners:
            ...
            code = self.extract_country_code(tuner_name, url)
...
_instance = LiveTvConfigEnrichmentService()
_url_looks_valid = _instance._url_looks_valid
extract_country_code = _instance.extract_country_code
enrich_livetv_entries = _instance.enrich_livetv_entries
