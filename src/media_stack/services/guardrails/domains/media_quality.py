"""Migration shim — see ``media_stack.application.guardrails.domains.media_quality``.
...
from ``media_stack.services.guardrails.domains.media_quality`` directly.
"""

from media_stack.application.guardrails.domains.media_quality import *  # noqa: F401, F403
