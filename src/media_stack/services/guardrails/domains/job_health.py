"""Migration shim — see ``media_stack.application.guardrails.domains.job_health``.
...
from ``media_stack.services.guardrails.domains.job_health`` directly.
"""

from media_stack.application.guardrails.domains.job_health import *  # noqa: F401, F403
