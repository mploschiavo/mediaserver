"""Migration shim — see ``media_stack.application.guardrails.domains.external_api``.
...
from ``media_stack.services.guardrails.domains.external_api`` directly.
"""

from media_stack.application.guardrails.domains.external_api import *  # noqa: F401, F403
