"""Migration shim — see ``media_stack.application.guardrails.domains.storage``.
...
from ``media_stack.services.guardrails.domains.storage`` directly.
"""

from media_stack.application.guardrails.domains.storage import *  # noqa: F401, F403
