"""Migration shim — see ``media_stack.application.guardrails.domains.auth``.
...
from ``media_stack.services.guardrails.domains.auth`` directly.
"""

from media_stack.application.guardrails.domains.auth import *  # noqa: F401, F403
