"""Migration shim — see ``media_stack.application.guardrails.registry``.
...
from ``media_stack.services.guardrails.registry`` directly.
"""

from media_stack.application.guardrails.registry import *  # noqa: F401, F403
