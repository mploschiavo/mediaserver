...
class PlanBuilderService:
    def build_plan_summary(self, runtime: ControllerRuntime) -> ControllerPlanSummary:
...
_instance = PlanBuilderService()
build_plan_summary = _instance.build_plan_summary
