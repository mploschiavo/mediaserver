"""Shim — moved to ``media_stack.domain.runtime_factory.plan_builder``
in ADR-0002 Phase 16-E (cross-cutting runtime_factory). Phase 16-F
removes this shim.
...
from media_stack.domain.runtime_factory import plan_builder as _impl
