...
class RuntimeHelpers:
    """Collection of runtime utility functions for torrent and disk operations."""
...
_instance = RuntimeHelpers()
to_float = _instance.to_float
disk_usage_percent = _instance.disk_usage_percent
fmt_bytes = _instance.fmt_bytes
