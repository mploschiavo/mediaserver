...
from media_stack.application.servarr.pipeline_service import ServarrPipelineService
from media_stack.infrastructure.servarr.runtime.arr_ops import (
    detect_arr_api_base,
...
from media_stack.infrastructure.servarr.runtime.factory import _health_service
...
from media_stack.adapters.servarr.servarr_adapters import AdapterDependencies


class ServarrRuntimeOps:
    ...
    def ensure_arr_discovery_lists_for_app(self, cfg, app_cfg, app_url, api_base, api_key):
        return _ensure_arr_discovery_lists_for_app(cfg, app_cfg, app_url, api_base, api_key)

    def trigger_arr_discovery_kickoff(self, cfg, app_cfg, app_url, api_base, api_key):
        return _trigger_arr_discovery_kickoff(cfg, app_cfg, app_url, api_base, api_key)


_instance = ServarrRuntimeOps()
run_servarr_pipeline = _instance.run_servarr_pipeline
...
trigger_arr_discovery_kickoff = _instance.trigger_arr_discovery_kickoff
_discovery_service = _instance._discovery_service
_ensure_arr_discovery_lists_for_app = _instance._ensure_arr_discovery_lists_for_app
_servarr_pipeline_service = _instance._servarr_pipeline_service
_trigger_arr_discovery_kickoff = _instance._trigger_arr_discovery_kickoff
