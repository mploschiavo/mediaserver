...
from media_stack.services.apps.servarr.technologies.traits import get_import_list_traits
from media_stack.services.apps.servarr.config_models_discovery import (
...
from media_stack.domain.discovery_lists.common import coerce_for_example
...
class DiscoveryImportListService:
    ...
    def resolve_import_list_definitions(self,
        service,
    ...
    def ensure_arr_discovery_lists_for_app(self,
        service,
        cfg: dict[str, Any],
        app_cfg: dict[str, Any],
        app_url: str,
...
_instance = DiscoveryImportListService()
