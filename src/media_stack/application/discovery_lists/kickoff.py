...
from media_stack.services.apps.servarr.technologies.traits import (
    get_discovery_kickoff_traits,
)



class DiscoveryKickoffService:
    def trigger_arr_discovery_kickoff(self,
        service,
        cfg: dict[str, Any],
...
_instance = DiscoveryKickoffService()
