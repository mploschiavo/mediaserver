"""Migration shim — see ``media_stack.services.security.session_aggregator``.
...
``src/`` or ``tests/`` imports from ``media_stack.application.security.session_aggregator`` directly.
"""

from media_stack.services.security.session_aggregator import *  # noqa: F401, F403
