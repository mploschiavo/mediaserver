"""Migration shim — see ``media_stack.services.security.api_token_aggregator``.
...
``src/`` or ``tests/`` imports from ``media_stack.application.security.api_token_aggregator`` directly.
"""

from media_stack.services.security.api_token_aggregator import *  # noqa: F401, F403
