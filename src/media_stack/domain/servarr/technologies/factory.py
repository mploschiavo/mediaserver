...
from media_stack.services.adapter_factory import build_adapter_registry, get_adapter_class
from media_stack.services.plugin_manifest_loader import (
    build_adapter_hook_defaults,
    load_plugin_manifests,
)
from media_stack.adapters.servarr.servarr_adapters import AdapterDependencies, HookFn
