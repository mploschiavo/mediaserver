...
# load-bearing. ``parents[4]`` from this file's location lands on the
# repo root in both the old (``services/media_integrity``) and new
# (``domain/media_integrity``) layouts; ADR-0002 Phase 16-E preserves
# the math.
_CONTRACT_PATH_REPO = (
