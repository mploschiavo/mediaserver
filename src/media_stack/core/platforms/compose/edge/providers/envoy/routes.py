...
def html_fallback_redirect_rewrite(
    *,
    path_prefix: str,
    strip_prefix: str,
) -> dict[str, Any] | None:
...
def html_accept_header_match() -> dict[str, Any]:
...
def referer_fallback_route_cfg(
    *,
    host: str,
    path_prefix: str,
    cluster_name: str,
...
def asset_referer_fallback_route_cfg(
    *,
    host: str,
    path_prefix: str,
    cluster_name: str,
...
def referer_html_redirect_fallback_route_cfg(
    *,
    host: str,
    path_prefix: str,
...
def cookie_html_redirect_fallback_route_cfg(
    *,
    path_prefix: str,
    regex_rewrite: dict[str, Any],
) -> dict[str, Any]:
