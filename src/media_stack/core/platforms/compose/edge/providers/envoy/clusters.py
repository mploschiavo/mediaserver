...
def build_cluster_entry(name: str, *, address: str, port: int) -> dict[str, Any]:
...
def build_clusters_from_service_map(
    ...
    for service_name in sorted(service_map.keys()):
        ...
        clusters.append(build_cluster_entry(name, address=address, port=port))
    return clusters
